export default function Footer() {
  return (
    <footer className="border-t bg-gradient-to-r from-sky-50 to-white dark:from-slate-900 dark:to-slate-800">
      <div className="container-max flex flex-col lg:flex-row items-center justify-between gap-5 py-6 text-sm text-gray-700 dark:text-gray-300">
        ...
        <div className="text-center text-xs opacity-80 px-2">© {new Date().getFullYear()} WeatherApp — Wszystkie prawa zastrzeżone</div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-full border border-gray-300/60 px-3 py-1 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:border-gray-600/60"
          >
            Repozytorium
          </a>
        </div>
